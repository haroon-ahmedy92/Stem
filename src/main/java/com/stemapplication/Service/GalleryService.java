...
public interface GalleryService {
    ...
    ResponseEntity<List<GalleryDto>> getGalleryItemsByCategory(String category);
    ...
    ResponseEntity<?> updateGalleryItem(Long id, GalleryCreateDto galleryCreateDto, String username);
