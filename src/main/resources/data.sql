...
-- ---------------------------------------------------------------
-- Team Members Table Creation and Data
-- ---------------------------------------------------------------
...
INSERT INTO team_members (name, qualification, role, address, email, phone, bio, research_interests, publications, created_at, updated_at) VALUES 
(
